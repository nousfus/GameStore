...
public class RepositoryComposition__BeanDefinitions {
  ...
  public static class RepositoryFragments {
    /**
     * Get the bean instance supplier for 'jpa.PaymentsDao.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.GameCategoriesDao.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.GameRequirementsDao.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.CartDao.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.GameVersionsDao.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.UserDao.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.GameVideosDao.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.UserRolesDao.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.CategoriesDao.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.DeveloperProfilesDao.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.LibraryDao.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.OrdersDao.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.GameDao.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.GameImagesDao.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.WishListDao.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.ReviewsDao.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.DiscountsDao.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.OrderDetailsDao.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.RolesDao.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.NotificationsDao.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.CartItemsDao.fragments#0'.
     */
