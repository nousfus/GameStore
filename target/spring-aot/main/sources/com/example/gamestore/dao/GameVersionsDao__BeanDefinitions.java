...
/**
 * Bean definitions for {@link GameVersionsDao}.
 */
@Generated
public class GameVersionsDao__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'gameVersionsDao'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getGameVersionsDaoInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'gameVersionsDao'.
   */
  public static BeanDefinition getGameVersionsDaoBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, GameVersionsDao.class, GameVersions.class, String.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.example.gamestore.dao.GameVersionsDao");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.GameVersionsDao.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.example.gamestore.dao.GameVersionsDaoImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getGameVersionsDaoInstanceSupplier();
