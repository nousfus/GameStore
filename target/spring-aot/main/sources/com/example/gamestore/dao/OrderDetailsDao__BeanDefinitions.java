...
/**
 * Bean definitions for {@link OrderDetailsDao}.
 */
@Generated
public class OrderDetailsDao__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'orderDetailsDao'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getOrderDetailsDaoInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'orderDetailsDao'.
   */
  public static BeanDefinition getOrderDetailsDaoBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, OrderDetailsDao.class, OrderDetails.class, String.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.example.gamestore.dao.OrderDetailsDao");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.OrderDetailsDao.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.example.gamestore.dao.OrderDetailsDaoImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getOrderDetailsDaoInstanceSupplier();
