...
/**
 * Bean definitions for {@link GameCategoriesDao}.
 */
@Generated
public class GameCategoriesDao__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'gameCategoriesDao'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getGameCategoriesDaoInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'gameCategoriesDao'.
   */
  public static BeanDefinition getGameCategoriesDaoBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, GameCategoriesDao.class, GameCategories.class, GameCategoriesId.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.example.gamestore.dao.GameCategoriesDao");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.GameCategoriesDao.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.example.gamestore.dao.GameCategoriesDaoImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getGameCategoriesDaoInstanceSupplier();
